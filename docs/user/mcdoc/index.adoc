...
<<t-range-delimiter>>::
	...
	`/../`
+
NOTE: Bikeshedding on the exclusive character is welcome.
...
Its syntax is derived from ranges used in Minecraft commands, with additional support for signaling an exclusive end using the `/` character.
