...
[[t-ident,IDENTIFIER]]
<<t-ident>>:: (<<t-ident-name>>)~pass:n[except: <<t-reserved-words>>]~

[[t-ident-name,IDENT_NAME]]
<<t-ident-name>>:: (<<t-ident-start>>) (<<t-ident-continue>>){star}
...
<<s-enum-field>>:: <<s-prelim>> <<t-ident-name>> `=` <<t-enum-value>>
...
<<t-static-index-key>>:: `%fallback` | `%none` | `%unknown` | <<t-ident-name>> | <<t-string>> | <<t-res-loc>>

[[t-accessor,ACCESSOR]]
<<t-accessor>>:: <<t-accessor-key>> (`.` <<t-accessor-key>>){star}

[[t-accessor-key,ACCESSOR_KEY]]
<<t-accessor-key>>:: `%key` | `%parent` | <<t-ident-name>> | <<t-string>>
****
...
<<s-attribute>>::
	`+#[+` <<t-ident-name>> `]` | +
	`+#[+` <<t-ident-name>> `=` <<s-attribute-value>> `]` | +
	`+#[+` <<t-ident-name>> <<s-attribute-tree-value>> `]`
...
<<s-attribute-named-value>>::
	(<<t-ident-name>> | <<t-string>>) `=` <<s-attribute-value>> | +
	(<<t-ident-name>> | <<t-string>>) <<s-attribute-tree-value>>
****
