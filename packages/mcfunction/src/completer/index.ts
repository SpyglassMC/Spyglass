...
import { CommandMacroNode, MacroChildNode, MacroNode } from '../node/index.js'
...
export function entry(
	...
	return (node, ctx) => {
		...
		if (core.CommentNode.is(childNode) || CommandMacroNode.is(childNode) || MacroNode.is(childNode) || MacroChildNode.is(childNode)) {
			return []
		} else {
