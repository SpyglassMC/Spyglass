...
import type { PartialRootTreeNode, PartialTreeNode, RootTreeNode } from './type'
...
export class CommandTreeRegistry {
	...
	public register(version: string, vanillaTree: VanillaCommandRootNode, treePatch?: PartialRootTreeNode): void {
		this.#trees.set(version, merge(vanillaTree, treePatch ?? CommandTreeRegistry.getTreePatch(version)))
	}
