...
import type { McmetaCommands, ReleaseVersion } from '../dependency/index.mjs'
...
import { inlayHintProvider } from './inlayHintProvider.mjs'
import * as parser from './parser/index.mjs'
import { signatureHelpProvider } from './signatureHelpProvider.mjs'
import { getPatch } from './tree/patch.mjs'
