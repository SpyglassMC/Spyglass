...
import type { CoordinateNode, ObjectiveCriteriaNode, VectorNode } from '../node/index.mjs'

export const objectiveCriterion: core.Colorizer<ObjectiveCriteriaNode> = node => [
...
export function register(meta: core.MetaRegistry) {
	...
	meta.registerColorizer<ObjectiveCriteriaNode>('mcfunction:objective_criteria', objectiveCriterion)
}
