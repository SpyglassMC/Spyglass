import { any, as, boolean, dispatch, extractNested, float, floatRange, intRange, listOf, literal, opt, pick, record, resource, simpleString, when } from '@spyglassmc/json/lib/checker/index.mjs'
import { nbt, versioned } from '../util/index.mjs'
import { block_state, HeightmapType, height_provider } from './common.mjs'
import { configured_feature_ref, placed_feature_ref } from './feature.mjs'
