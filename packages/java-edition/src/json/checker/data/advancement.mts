...
import type { JsonCheckerContext } from '@spyglassmc/json/lib/checker/index.mjs'
import { any, as, boolean, dispatch, extract, extractStringArray, int, listOf, literal, object, opt, pick, record, ref, resource, simpleString, string, when } from '@spyglassmc/json/lib/checker/primitives/index.mjs'
import { dissectUri } from '../../../binder/index.mjs'
import { blockStateMap, criterionReference, deprecated, nbt, versioned } from '../util/index.mjs'
import { float_bounds, int_bounds, Slots } from './common.mjs'
import { predicate } from './loot_table.mjs'
import { text_component } from './text_component.mjs'
