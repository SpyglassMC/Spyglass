import { any, as, boolean, dispatch, float, floatRange, int, intRange, listOf, literal, object, opt, pick, record, ref, resource, simpleString } from '@spyglassmc/json/lib/checker/primitives/index.mjs'
import { versioned } from '../util/index.mjs'
import { block_state, noise_parameters, vertical_anchor } from './common.mjs'
