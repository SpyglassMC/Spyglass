...
import { as, int, record } from '@spyglassmc/json/lib/checker/index.mjs'
import type { JsonChecker } from '@spyglassmc/json/lib/checker/JsonChecker.mjs'
import { advancement } from './advancement.mjs'
import { biome, configured_carver, configured_surface_builder } from './biome.mjs'
import { dimension, dimension_type, noise_settings } from './dimension.mjs'
import { configured_feature } from './feature.mjs'
import { item_modifier_list, loot_table, predicate_list } from './loot_table.mjs'
import { recipe } from './recipe.mjs'
import { configured_structure_feature, processor_list, template_pool } from './structure.mjs'
import { block_tag, entity_type_tag, fluid_tag, function_tag, game_event_tag, item_tag } from './tag.mjs'
