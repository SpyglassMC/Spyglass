...
import { any, as, boolean, dispatch, float, floatRange, int, intRange, listOf, literal, object, opt, record, resource, when } from '@spyglassmc/json/lib/checker/primitives/index.mjs'
import { intColor, versioned } from '../util/index.mjs'
import { block_state, floatProvider, height_provider, vertical_anchor } from './common.mjs'
import { configured_feature_list_ref, placed_feature_list_ref } from './feature.mjs'
import { configured_structure_feature } from './structure.mjs'
