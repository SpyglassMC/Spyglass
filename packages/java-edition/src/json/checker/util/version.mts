import type { JsonChecker, JsonCheckerContext, record } from '@spyglassmc/json/lib/checker/index.mjs'
import { deprecate } from '@spyglassmc/json/lib/checker/index.mjs'
