import type { AstNode, BooleanBaseNode, BooleanNode, CommentNode, FileNode, FloatBaseNode, FloatNode, IntegerNode, LiteralBaseNode, LiteralNode, LongNode, ResourceLocationBaseNode, StringBaseNode, StringNode } from '../../node/index.js'
