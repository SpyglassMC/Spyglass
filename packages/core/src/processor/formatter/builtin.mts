import type { AstNode, BooleanBaseNode, BooleanNode, CommentNode, FileNode, FloatBaseNode, FloatNode, IntegerNode, LiteralBaseNode, LiteralNode, LongNode, ResourceLocationBaseNode, StringBaseNode, StringNode } from '../../node/index.mjs'
import { ResourceLocationNode } from '../../node/index.mjs'
import type { MetaRegistry } from '../../service/index.mjs'
import type { Formatter } from './Formatter.mjs'
