...
export function traversePreOrder<CN extends AstNode>(
	node: DeepReadonly<AstNode>,
	shouldContinue: Callback<unknown>,
	shouldCallFn: (this: void, node: AstNode, parents: AstNode[]) => node is CN,
	fn: (this: void, node: CN, parents: AstNode[]) => void,
): void
export function traversePreOrder(
	node: DeepReadonly<AstNode>,
	shouldContinue: Callback<unknown>,
	shouldCallFn: Callback<unknown>,
	fn: Callback<void>,
): void
export function traversePreOrder(
	node: DeepReadonly<AstNode>,
