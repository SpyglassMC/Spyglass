...
import { isIterable } from '../common/index.mjs'
import type { RangeLike } from '../source/index.mjs'
import { Location, PositionRange, Range } from '../source/index.mjs'
...
// Data in `java-edition/src/binder/index.mts` may need to be updated when this section is changed.
