 ...
 */
const intRange = _range<IntegerNode, IntRangeNode>('mcdoc:int_range', integer(), fallibleInteger())

/**
 * `Failure` when there is no `@` marker.
 */
const unsignedRange = _range<IntegerNode, UnsignedRangeNode>('mcdoc:unsigned_range', integer(true), fallibleInteger(true))
