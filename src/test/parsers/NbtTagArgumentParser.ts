...
describe.skip('NbtTagArgumentParser Tests', () => {
    ...
    describe('parse() Tests', () => {
        it('Should parse quoted string tags', () => {
            ...
            assert.deepStrictEqual(data, getNbtStringTag('bar"'))
        ...
        it('Should handle errors for quoted string tags', () => {
            ...
            const reader = new StringReader("'bar")
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtStringTag(''))
        ...
        it('Should return regular unquoted string', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtStringTag('foo'))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        it('Should return byte', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtByteTag(1))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        it('Should treat false as byte', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtByteTag(0))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        ...
        it('Should return short', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtShortTag(32767))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        it('Should return int', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtIntTag(1234567))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        it('Should return long', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtLongTag(new BigNumber('-1234567890')))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        it('Should return float', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtFloatTag(1.23))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        it('Should return double', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtDoubleTag(1.23))
            assert.deepStrictEqual(errors, [])
            assert.deepStrictEqual(cache, { def: {}, ref: {} })
            assert.deepStrictEqual(completions, [])
        })
        ...
        it('Should treat an out-of-range byte as unquoted string', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtStringTag('233b'))
        ...
        it('Should treat an out-of-range short as unquoted string', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtStringTag('32768s'))
            assert.deepStrictEqual(errors, [new ParsingError(
                { start: 0, end: 6 },
        ...
        it('Should treat an out-of-range int as unquoted string', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtStringTag('12345678901234'))
            assert.deepStrictEqual(errors, [new ParsingError(
                { start: 0, end: 14 },
        ...
        it('Should treat an out-of-range long as unquoted string', () => {
            ...
            const { data, errors, cache, completions } = parser.parse(reader, undefined, VanillaConfig, globalCache)
            assert.deepStrictEqual(data, getNbtStringTag('-9223372036854775809L'))
            assert.deepStrictEqual(errors, [new ParsingError(
                { start: 0, end: 21 },
