...
/**
 * Command tree of Minecraft Java Edition 1.19.4 commands.
 */
...
export const CommandTree: ICommandTree = {
    ...
    commands: {
        ...
        gamerule: {
            ...
            children: {
                boolRuleName: {
                    parser: new LiteralArgumentParser('announceAdvancements', 'blockExplosionDropDecay', 'commandBlockOutput', 'disableElytraMovementCheck', 'disableRaids', 'doDaylightCycle', 'doEntityDrops', 'doFireTick', 'doImmediateRespawn', 'doInsomnia', 'doLimitedCrafting', 'doMobLoot', 'doMobSpawning', 'doPatrolSpawning', 'doTileDrops', 'doTraderSpawning', 'doWardenSpawning', 'doWeatherCycle', 'drowningDamage', 'fallDamage', 'fireDamage', 'forgiveDeadPlayers', 'freezeDamage', 'globalSoundEvents', 'keepInventory', 'lavaSourceConversion', 'logAdminCommands', 'mobExplosionDropDecay', 'mobGriefing', 'naturalRegeneration', 'reducedDebugInfo', 'sendCommandFeedback', 'showDeathMessages', 'spectatorsGenerateChunks', 'tntExplosionDropDecay', 'universalAnger', 'waterSourceConversion'),
                    executable: true,
                    children: {
                        value: {
                            template: 'templates.boolean',
